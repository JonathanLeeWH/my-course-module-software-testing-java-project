...
public class IORedirectionIT {
    ...
    private static final String FILENAME1 = "IOTestFile1.txt";
    private static final String FILENAME2 = "IOTestFile2.txt";
    private static final String FILENAME3 = "IOTestFile3.txt";
